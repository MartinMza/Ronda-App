...
import {localHostIP} from "../../../localHostIP.json"
...
const Register = () => {
  ...
  const handleSubmit = ()=>{
    console.log("hola")
    axios.post(`http://${localHostIP}/api/auth/register`,{
      name:name.value,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput placeholder="Email" type="email" style={styles.input} {...email}/>
      <TextInput placeholder="Password" secureTextEntry={true} style={styles.input} {...password} />
